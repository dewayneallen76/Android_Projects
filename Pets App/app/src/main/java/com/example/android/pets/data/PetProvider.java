...
public class PetProvider extends ContentProvider {
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        // If weight is provided check to make sure that it is equal to or greater than 0kg
        ...
        // If the ID is -1, then insertion failed. Log and error and return null.
        if (id == -1) {
            Log.e(LOG_TAG, "Failed to insert for row " + uri);
            return null;
        }
    ...
    private int updatePet(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        /**
         * If the {@link PetEntry#COLUMN_PET_WEIGHT} key is present, check that the weight value
         * is valid.
         */
        ...
        // If there are no values to update, do not try to update the database.
        if (values.size() == 0) {
            return 0;
        }
        ...
        // If 1 or more of the rows were updated, then notify all listeners that the data at the
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        // If 1 or more rows deleted, then notify all listeners that the data at the given URI
        // has changed.
        if (rowsDeleted != 0) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
