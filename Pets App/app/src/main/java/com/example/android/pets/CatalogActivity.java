...
public class CatalogActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Find the ListView which will populate with the pet data
        ListView petListView = (ListView) findViewById(R.id.list);

        // Find and set empty view on the ListView, so that it only shows when the list item
        //has 0 items
    ...
    private void insertPet() {
        ...
        // Insert a new row for Toto in the database, using content resolver
        ...
        if (newUri == null) {
            // If the new row ID was -1 then there was an error.
    ...
    public void deleteAllPets() {
        ...
        Log.v("Catalog Activity", rowsDeleted + " rows deleted from database");
    }
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        // Define a projection that specifies the columns from the table we want to access
        String [] projection = {
